    ...
    private void createDialogConfirm(int id) {
        switch (id) {
            ...
            case DIALOG_SETUP_PASSWORD_PRIVATEMODE:
                ...
                final EditText password =  mConfirmDialog
                        .findViewById(R.id.dialog_setup_confirm_edt_password);
                final EditText passwordConfirm =  mConfirmDialog
                ...
                final TextSwitcher message =  mConfirmDialog
                ...
                Button OK =  mConfirmDialog
                        .findViewById(R.id.dialog_setup_confirm_btn_ok);
                Button Cancel =  mConfirmDialog

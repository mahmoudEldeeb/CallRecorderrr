...
import com.SMAStudios.Call_Recording_program.adapter.InboxAdapter;
import com.SMAStudios.Call_Recording_program.controller.UploadFile;
...
public class InboxFragment extends Fragment implements InboxAdapter.ViewHolder.ClickListener,MyConstants {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mlink=v.findViewById(R.id.mlink);
    ...
    public void onResume() {
        ...
        intentFilter.addAction(ACTION_BROADCAST_SAVED_INTENT_UPDATE_LIST_RECORD);
        intentFilter.addAction(ACTION_BROADCAST_INBOX_INTENT_UPDATE_LIST_RECORD_NAME);
    ...
    private BroadcastReceiver mMessageUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if(action.equals(ACTION_BROADCAST_INBOX_INTENT_UPDATE_LIST_RECORD_NAME)){

                String updateName = intent.getStringExtra("player_update_name");
                Log.v("qqqq",updateName+"    ffff");
                mInboxAdapter.notifyUpdateName(positionNeedUpdate,updateName);
                // mInboxAdapter.notifyDataSetChanged();

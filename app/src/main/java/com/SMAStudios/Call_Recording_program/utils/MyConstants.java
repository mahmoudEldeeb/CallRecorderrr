package com.SMAStudios.Call_Recording_program.utils;
...
public interface MyConstants {
    ...
    int FILE_TYPE_WAV                      = 1002;
    int FILE_TYPE_MP4                      = 1003;
    int FILE_TYPE_AMR                      = 1004;
    ...
    String FILE_DIRECTORY                  = "SMAStudios_Recorder";
    ...
    //broadcast key
    String ACTION_BROADCAST_INBOX_INTENT_UPDATE_LIST_RECORD = "com.SMAStudios.Call_Recording_program.inbox.updatelist";
    String ACTION_BROADCAST_INBOX_INTENT_UPDATE_NOTE = "com.SMAStudios.Call_Recording_program.player.inbox.updatenote";
    String ACTION_BROADCAST_SAVED_INTENT_UPDATE_LIST_RECORD = "com.SMAStudios.Call_Recording_program.saved.updatelist";
    String ACTION_BROADCAST_SAVED_INTENT_UPDATE_NOTE = "com.SMAStudios.Call_Recording_program.player.saved.updatenote";
    String ACTION_BROADCAST_INBOX_INTENT_UPDATE_LIST_RECORD_NAME = "com.SMAStudios.Call_Recording_program.inbox.updatename";
    String ACTION_BROADCAST_INTENT_DELETE_ALL = "com.SMAStudios.Call_Recording_program.storage.deleteall";

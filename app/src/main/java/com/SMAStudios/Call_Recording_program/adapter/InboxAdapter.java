...
import com.SMAStudios.Call_Recording_program.model.ContactCache;
...
/*    public int getPosition(int position) {
    ...
    public void notifyUpdateName(int pos,String updateName){
        mCache.set(pos,new ContactCache());
        mListRecord.get(pos).setPhoneNumber(updateName);
